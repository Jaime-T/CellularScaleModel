...
def main():
    ...
    num_workers = 1
    num_devices = 1
    resources_per_worker = {"CPU": 8, "GPU": 1 } # add later: , "GPU": 1 
    ...
    print("Training missense data:")
    train(model, ms_loader, val_loader=None, epochs=3)

    print("Training frameshift data:")
    train(model, fs_loader, val_loader=None, epochs=3)
