...
"""
Bigger learning rate (5e-2), smaller r (2) and alpha lora (4, bigger epochs (5)

For missense mutation data
...
def train_model(tokenizer, model, descr, train_dataset, lora_config, batch_size=6, epochs=5, lr=5e-2):
    t0 = timer()
    ...
    loss_per_epoch = []
    base_dir = f"/g/data/gi52/jaime/trained/esm2_650M_model/{descr}/run3"
